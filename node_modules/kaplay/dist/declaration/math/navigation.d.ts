...
export declare function breadthFirstSearch(graph: Graph, start: number, goal: number): any[];
export declare function dijkstraSearch(graph: Graph, start: number, goal: number): any[];
