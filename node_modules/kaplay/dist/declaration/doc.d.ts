...
declare class Event$1<Args extends any[] = any[]> {
	private handlers;
 ...
 * @group Start
 */
declare function kaplay<TPlugins extends PluginList<unknown> = [
	undefined
], TButtons extends ButtonsDef = {}, TButtonsName extends string = keyof TButtons & string>(options?: KaboomOpt<TPlugins, TButtons>): TPlugins extends [
	undefined
] ? KaboomCtx<TButtons, TButtonsName> : KaboomCtx<TButtons, TButtonsName> & MergePlugins<TPlugins>;
export type InternalCtx = {
	...
	calcTransform: (obj: GameObj) => Mat4$1;
};
/**
...
export interface KaboomCtx<TButtonDef extends ButtonsDef = {}, TButton extends string = string> {
	 ...
	 * @group Math
	 */
	raycast(origin: Vec2, direction: Vec2, exclude?: string[]): RaycastResult$1;
	/**
	 ...
	 * @group Math
	 */
	Circle: typeof Circle$1;
	/**
	 * @group Math
	 */
	Ellipse: typeof Ellipse$1;
	/**
	 * @group Math
	 */
	Polygon: typeof Polygon$1;
	/**
	 * @group Math
	 */
	Vec2: typeof Vec2;
 ...
 * @group Input
 */
type GamepadButton$1 = "north" | "east" | "south" | "west" | "ltrigger" | "rtrigger" | "lshoulder" | "rshoulder" | "select" | "start" | "lstick" | "rstick" | "dpad-up" | "dpad-right" | "dpad-down" | "dpad-left" | "home" | "capture";
/**
 * A gamepad stick.
 *
 * @group Input
...
export type ButtonBinding = {
	keyboard?: Key | Key[];
	gamepad?: GamepadButton$1 | GamepadButton$1[];
 ...
 * @group Math
 */
declare class Mat4$1 {
	m: number[];
	constructor(m?: number[]);
	static translate(p: Vec2): Mat4$1;
	static scale(s: Vec2): Mat4$1;
	static rotateX(a: number): Mat4$1;
	static rotateY(a: number): Mat4$1;
	static rotateZ(a: number): Mat4$1;
	clone(): Mat4$1;
	mult(other: Mat4$1): Mat4$1;
	multVec2(p: Vec2): Vec2;
	translate(p: Vec2): Mat4$1;
	scale(s: Vec2): Mat4$1;
	rotate(a: number): Mat4$1;
	getTranslation(): Vec2;
	getScale(): Vec2;
	getRotation(): number;
	getSkew(): Vec2;
 ...
 * @group Math
 */
type ShapeType$1 = Vec2 | Circle$1 | Ellipse$1 | Line$1 | Rect$1 | Polygon$1;
/**
 * @group Math
 */
type RaycastHit$1 = {
 ...
 * @group Math
 */
type RaycastResult$1 = RaycastHit$1 | null;
/**
 * @group Math
 */
declare class Rect$1 {
	pos: Vec2;
	width: number;
	height: number;
	constructor(pos: Vec2, width: number, height: number);
	static fromPoints(p1: Vec2, p2: Vec2): Rect$1;
	center(): Vec2;
	points(): [
		Vec2,
		Vec2,
	...
	transform(m: Mat4$1): Polygon$1;
	bbox(): Rect$1;
	area(): number;
	clone(): Rect$1;
	distToPoint(p: Vec2): number;
	sdistToPoint(p: Vec2): number;
	collides(shape: ShapeType$1): boolean;
	contains(point: Vec2): boolean;
	raycast(origin: Vec2, direction: Vec2): RaycastResult$1;
}
/**
 * @group Math
 */
 ...
 * @group Math
 */
declare class Circle$1 {
	center: Vec2;
	radius: number;
	constructor(pos: Vec2, radius: number);
	transform(m: Mat4$1): Ellipse$1;
	bbox(): Rect$1;
	area(): number;
	clone(): Circle$1;
	collides(shape: ShapeType$1): boolean;
 ...
 * @group Draw
 */
export type Shape = Rect$1 | Line$1 | Point | Circle$1 | Ellipse$1 | Polygon$1;
/**
 * @group Component System
 */
 ...
 * @group Math
 */
export type UniformValue = number | Vec2 | Color | Mat4$1 | number[] | Vec2[] | Color[];
/**
 * @group Math
 */
...
export {
	...
	RaycastHit$1 as RaycastHit,
	RaycastResult$1 as RaycastResult,
	Rect$1 as Rect,
	ShapeType$1 as ShapeType,
	kaplay as default,
};
