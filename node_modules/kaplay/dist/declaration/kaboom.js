...
function area(opt = {}) {
  ...
  return {
    ...
    inspect() {
      ...
      else return `area: (${this.area.scale.x.toFixed(1)}x, ${this.area.scale.y.toFixed(1)}y)`;
    }
  };
}
...
function scale(...args) {
  ...
  return {
    ...
    inspect() {
      ...
      else return `scale: (${this.scale.x.toFixed(1)}x, ${this.scale.y.toFixed(1)}y)`;
    }
  };
}
...
var kaplay = (gopt = {}) => {
  ...
  function drawTexture(opt) {
    ...
    if (opt.tiled) {
      ...
      const offset = anchor2.scale(repX * w, repY * h);
